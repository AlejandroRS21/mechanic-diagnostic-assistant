...
- [x] **1. RAG System**: Qdrant vector database with 42+ automotive documents
...
3. **Initialize KB**: First run builds Qdrant (takes 2-3 minutes)
...
- Qdrant persists to `./qdrant_db/` directory
